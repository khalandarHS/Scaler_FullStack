...
console.log("circle area: " + calculateArea(myRadiusArr));
console.log("circle circumference: " + calculateCircumference(myRadiusArr));
console.log("circle Diameter: " + calculateDiameter(myRadiusArr));
...
console.log("circumference: " + calculate(myRadiusArr, calculateCircumference));
